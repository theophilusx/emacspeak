...
emacspeak-dismal-row-summarizer-list"
  (interactive)
  (defvar emacspeak-dismal-row-summarizer-list)
...
emacspeak-dismal-col-summarizer-list"
  (interactive)
  (defvar emacspeak-dismal-col-summarizer-list)
(defvar emacspeak-dismal-value-personality)
(defvar voice-lock-mode)
(defvar dismal-current-col)
...
(defun emacspeak-dismal-set-sheet-summarizer-list ()
  ...
  (interactive)
  (defvar emacspeak-dismal-sheet-summarizer-list)
