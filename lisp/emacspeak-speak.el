...
(defun emacspeak-notifications-truncate ()
  ...
  (defvar emacspeak-notifications-buffer)
(defvar emacspeak-notifications-max)
...
Useful to do this before you listen to an entire buffer."
  ...
  (defvar emacspeak-speak-voice-annotated-paragraphs)
  (when
...
(defun emacspeak-speak-lookup-persistent-filter (key)
  ...
  (defvar emacspeak-speak-filter-table)
  (or
   (gethash
...
(defun emacspeak-speak-load-filter-settings ()
  ...
  (defvar emacspeak-speak-filter-persistent-store)
(defvar emacspeak-speak-filter-table)
(defvar emacspeak-speak-filters-loaded-p)
...
(defun emacspeak-mail-alert-user-p (f)
  ...
  (defvar emacspeak-mail-last-alerted-time)
(defvar emacspeak-mail-alert-interval)
...
(defvar global-visual-line-mode)
...
Optional second arg `set' sets the TZ environment variable as well."
  (interactive
   (list
    ...
    current-prefix-arg))
  (defvar emacspeak-speak-time-format)
...
(defvar emacspeak-repeat-was-active)
  (cond
...
"
  (interactive )
  (defvar emacspeak-buffer-select-help)
