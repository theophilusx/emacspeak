...
(defun emacspeak-gomoku-display-statistics ()
  ...
  (interactive)
  (defvar gomoku-number-of-human-wins)
(defvar gomoku-number-of-emacs-wins)
(defvar gomoku-number-of-draws)
