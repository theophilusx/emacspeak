...
Optional interactive prefix  arg defines a pronunciation that
  ...
  (interactive
   (list
    ...
    current-prefix-arg))
  (defvar emacspeak-erc-people-to-monitor)
...
(defvar emacspeak-erc-speak-all-participants)
(defvar emacspeak-erc-monitor-my-messages)
...
(defadvice erc-display-line-buffer  (after emacspeak pre act
                                           comp)
  "Speech-enable ERC."
  (defvar emacspeak-erc-room-monitor)
(defvar emacspeak-erc-monitor-my-messages)
(defvar emacspeak-erc-my-nick)
